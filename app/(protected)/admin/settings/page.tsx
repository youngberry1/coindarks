...
export const metadata: Metadata = {
    title: "System Control | CoinDarks Admin",
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 lg:gap-10">
                <div className="space-y-4 max-w-full overflow-hidden">
                    <div className="flex items-center gap-2.5 sm:gap-3">
                        ...
                        <span className="text-[8px] sm:text-[10px] font-black uppercase tracking-[0.2em] sm:tracking-[0.4em] text-foreground/40 truncate">Master Matrix : System Configuration</span>
                    </div>
                    <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-tight leading-[0.9] uppercase wrap-break-word">
                        System <br />
                        <span className="text-gradient leading-relaxed">Control.</span>
                    </h1>
                    <p className="text-sm sm:text-base lg:text-xl text-foreground/50 font-medium max-w-2xl leading-relaxed wrap-break-word">
                        Configure institutional parameters, manage registry endpoints,
                        and audit system-wide security ciphers across the global bridge.
                    </p>
                </div>
                ...
                <div className="flex items-center gap-3 sm:gap-4 shrink-0">
                    <div className="h-10 sm:h-14 px-4 sm:px-6 rounded-xl sm:rounded-2xl glass border border-white/5 flex items-center gap-2.5 sm:gap-3 text-foreground/30 shadow-2xl">
                        ...
                        <span className="text-[8px] sm:text-[10px] font-black uppercase tracking-[0.15em] sm:tracking-widest">Mainframe Active</span>
                    </div>
                </div>
            </div>
